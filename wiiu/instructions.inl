...
INS(ps_div, (frd), (fra, frb), (rc), (opcd == 4, xo4 == 18), "")
INS(ps_sub, (frd), (fra, frb), (rc), (opcd == 4, xo4 == 20), "")
INS(ps_add, (frd), (fra, frb), (rc), (opcd == 4, xo4 == 21), "")
INS(ps_sel, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 23), "")
INS(ps_res, (frd), (frb), (rc), (opcd == 4, xo4 == 24), "")
INS(ps_mul, (frd), (fra, frc), (rc), (opcd == 4, xo4 == 25), "")
INS(ps_rsqrte, (frd), (frb), (rc), (opcd == 4, xo4 == 26), "")
INS(ps_msub, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 28), "")
INS(ps_madd, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 29), "")
INS(ps_nmsub, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 30), "")
INS(ps_nmadd, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 31), "")
INS(ps_neg, (frd), (frb), (rc), (opcd == 4, xo1 == 40), "")
INS(ps_mr, (frd), (frb), (rc), (opcd == 4, xo1 == 72), "")
INS(ps_nabs, (frd), (frb), (rc), (opcd == 4, xo1 == 136), "")
INS(ps_abs, (frd), (frb), (rc), (opcd == 4, xo1 == 264), "")
INS(ps_sum0, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 10), "")
INS(ps_sum1, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 11), "")
INS(ps_muls0, (frd), (fra, frc), (rc), (opcd == 4, xo4 == 12), "")
INS(ps_muls1, (frd), (fra, frc), (rc), (opcd == 4, xo4 == 13), "")
INS(ps_madds0, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 14), "")
INS(ps_madds1, (frd), (fra, frb, frc), (rc), (opcd == 4, xo4 == 15), "")
INS(ps_cmpu0, (crfd), (fra, frb), (), (opcd == 4, xo1 == 0), "")
INS(ps_cmpo0, (crfd), (fra, frb), (), (opcd == 4, xo1 == 32), "")
INS(ps_cmpu1, (crfd), (fra, frb), (), (opcd == 4, xo1 == 64), "")
INS(ps_cmpo1, (crfd), (fra, frb), (), (opcd == 4, xo1 == 96), "")
INS(ps_merge00, (frd), (fra, frb), (rc), (opcd == 4, xo1 == 528), "")
INS(ps_merge01, (frd), (fra, frb), (rc), (opcd == 4, xo1 == 560), "")
INS(ps_merge10, (frd), (fra, frb), (rc), (opcd == 4, xo1 == 592), "")
INS(ps_merge11, (frd), (fra, frb), (rc), (opcd == 4, xo1 == 624), "")
