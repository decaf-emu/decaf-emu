...
ALU_OP2(SETE_DX10,               0x0000000C, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETGT_DX10,              0x0000000D, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETGE_DX10,              0x0000000E, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETNE_DX10,              0x0000000F, 2, ALU_VEC | ALU_TRANS)
...
ALU_OP2(MOVA,                    0x00000015, 1, ALU_VEC)
ALU_OP2(MOVA_FLOOR,              0x00000016, 1, ALU_VEC)
ALU_OP2(ADD_64,                  0x00000017, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(MOVA_INT,                0x00000018, 1, ALU_VEC)
...
ALU_OP2(PRED_SETGT_UINT,         0x0000001E, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGE_UINT,         0x0000001F, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETE,               0x00000020, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGT,              0x00000021, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGE,              0x00000022, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETNE,              0x00000023, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SET_INV,            0x00000024, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SET_POP,            0x00000025, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SET_CLR,            0x00000026, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SET_RESTORE,        0x00000027, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETE_PUSH,          0x00000028, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGT_PUSH,         0x00000029, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGE_PUSH,         0x0000002A, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETNE_PUSH,         0x0000002B, 2, ALU_VEC | ALU_TRANS)
...
ALU_OP2(AND_INT,                 0x00000030, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(OR_INT,                  0x00000031, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(XOR_INT,                 0x00000032, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(NOT_INT,                 0x00000033, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(ADD_INT,                 0x00000034, 2, ALU_VEC | ALU_REDUC)
ALU_OP2(SUB_INT,                 0x00000035, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(MAX_INT,                 0x00000036, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(MIN_INT,                 0x00000037, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(MAX_UINT,                0x00000038, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(MIN_UINT,                0x00000039, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETE_INT,                0x0000003A, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETGT_INT,               0x0000003B, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETGE_INT,               0x0000003C, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETNE_INT,               0x0000003D, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETGT_UINT,              0x0000003E, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(SETGE_UINT,              0x0000003F, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(KILLGT_UINT,             0x00000040, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(KILLGE_UINT,             0x00000041, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETE_INT,           0x00000042, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGT_INT,          0x00000043, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGE_INT,          0x00000044, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETNE_INT,          0x00000045, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(KILLE_INT,               0x00000046, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(KILLGT_INT,              0x00000047, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(KILLGE_INT,              0x00000048, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(KILLNE_INT,              0x00000049, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETE_PUSH_INT,      0x0000004A, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGT_PUSH_INT,     0x0000004B, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETGE_PUSH_INT,     0x0000004C, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETNE_PUSH_INT,     0x0000004D, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETLT_PUSH_INT,     0x0000004E, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(PRED_SETLE_PUSH_INT,     0x0000004F, 2, ALU_VEC | ALU_TRANS)
...
ALU_OP2(MOVA_GPR_INT,            0x00000060, 2, ALU_VEC)
...
ALU_OP2(FLT_TO_INT,              0x0000006B, 1, ALU_TRANS)
ALU_OP2(INT_TO_FLT,              0x0000006C, 1, ALU_TRANS)
ALU_OP2(UINT_TO_FLT,             0x0000006D, 1, ALU_TRANS)
ALU_OP2(SIN,                     0x0000006E, 1, ALU_TRANS)
ALU_OP2(COS,                     0x0000006F, 1, ALU_TRANS)
ALU_OP2(ASHR_INT,                0x00000070, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(LSHR_INT,                0x00000071, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(LSHL_INT,                0x00000072, 2, ALU_VEC | ALU_TRANS)
ALU_OP2(MULLO_INT,               0x00000073, 2, ALU_TRANS)
ALU_OP2(MULHI_INT,               0x00000074, 2, ALU_TRANS)
ALU_OP2(MULLO_UINT,              0x00000075, 2, ALU_TRANS)
ALU_OP2(MULHI_UINT,              0x00000076, 2, ALU_TRANS)
ALU_OP2(RECIP_INT,               0x00000077, 1, ALU_TRANS)
ALU_OP2(RECIP_UINT,              0x00000078, 1, ALU_TRANS)
ALU_OP2(FLT_TO_UINT,             0x00000079, 1, ALU_TRANS)
ALU_OP2(LDEXP_64,                0x0000007A, 2, ALU_VEC | ALU_REDUC)
ALU_OP2(FRACT_64,                0x0000007B, 1, ALU_VEC | ALU_REDUC)
ALU_OP2(PRED_SETGT_64,           0x0000007C, 2, ALU_VEC | ALU_REDUC)
ALU_OP2(PRED_SETE_64,            0x0000007D, 2, ALU_VEC | ALU_REDUC)
ALU_OP2(PRED_SETGE_64,           0x0000007E, 2, ALU_VEC | ALU_REDUC)

// ALU OP3
ALU_OP3(BFE_UINT,                0x00000004, 3, ALU_VEC | ALU_TRANS)
ALU_OP3(BFE_INT,                 0x00000005, 3, ALU_VEC | ALU_TRANS)
ALU_OP3(BFI_INT,                 0x00000006, 3, ALU_VEC | ALU_TRANS)
...
ALU_OP3(CNDE_INT,                0x0000001C, 3, ALU_VEC | ALU_TRANS)
ALU_OP3(CNDGT_INT,               0x0000001D, 3, ALU_VEC | ALU_TRANS)
ALU_OP3(CNDGE_INT,               0x0000001E, 3, ALU_VEC | ALU_TRANS)
