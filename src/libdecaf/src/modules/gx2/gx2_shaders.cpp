...
GX2SetFetchShader(GX2FetchShader *shader)
{
   ...
   internal::writePM4(SetContextRegs { latte::Register::SQ_PGM_START_FS, gsl::make_span(shaderRegData) });

   uint32_t vgt_instance_step_rates[] = {
      shader->divisors[0],
      shader->divisors[1],
   };
   internal::writePM4(SetContextRegs { latte::Register::VGT_INSTANCE_STEP_RATE_0, gsl::make_span(vgt_instance_step_rates) });
...
GX2SetVertexShader(GX2VertexShader *shader)
{
   ...
   if (shader->mode != GX2ShaderMode::GeometryShader) {
      internal::writePM4(SetContextRegs { latte::Register::SQ_PGM_START_VS, gsl::make_span(shaderRegData) });
      internal::writePM4(SetContextReg { latte::Register::VGT_PRIMITIVEID_EN, vgt_primitiveid_en.value });
      internal::writePM4(SetContextReg { latte::Register::SPI_VS_OUT_CONFIG, spi_vs_out_config.value });
      internal::writePM4(SetContextReg { latte::Register::PA_CL_VS_OUT_CNTL, pa_cl_vs_out_cntl.value });
      ...
      internal::writePM4(SetContextReg { latte::Register::SQ_PGM_CF_OFFSET_VS, 0 });

      if (shader->hasStreamOut) {
         internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_VTX_STRIDE_0, shader->streamOutStride[0] >> 2 });
         internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_VTX_STRIDE_1, shader->streamOutStride[1] >> 2 });
         internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_VTX_STRIDE_2, shader->streamOutStride[2] >> 2 });
         internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_VTX_STRIDE_3, shader->streamOutStride[3] >> 2 });
      }

      internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_BUFFER_EN, vgt_strmout_buffer_en.value });
   } else {
      internal::writePM4(SetContextRegs { latte::Register::SQ_PGM_START_ES, gsl::make_span(shaderRegData) });
      internal::writePM4(SetContextReg { latte::Register::SQ_ESGS_RING_ITEMSIZE, ringItemsize });
   }

   internal::writePM4(SetContextReg { latte::Register::SQ_VTX_SEMANTIC_CLEAR, sq_vtx_semantic_clear.value });
   ...
   internal::writePM4(SetContextReg { latte::Register::VGT_VERTEX_REUSE_BLOCK_CNTL, vgt_vertex_reuse_block_cntl.value });
   internal::writePM4(SetContextReg { latte::Register::VGT_HOS_REUSE_DEPTH, vgt_hos_reuse_depth.value });
...
GX2SetPixelShader(GX2PixelShader *shader)
{
   ...
   internal::writePM4(SetContextRegs { latte::Register::SQ_PGM_START_PS, gsl::make_span(shaderRegData) });

   uint32_t spi_ps_in_control[] = {
      spi_ps_in_control_0.value,
      spi_ps_in_control_1.value,
   };
   internal::writePM4(SetContextRegs { latte::Register::SPI_PS_IN_CONTROL_0, gsl::make_span(spi_ps_in_control) });
   ...
   internal::writePM4(SetContextReg { latte::Register::CB_SHADER_MASK, cb_shader_mask.value });
   internal::writePM4(SetContextReg { latte::Register::CB_SHADER_CONTROL, cb_shader_control.value });
   internal::writePM4(SetContextReg { latte::Register::DB_SHADER_CONTROL, db_shader_control.value });
   internal::writePM4(SetContextReg { latte::Register::SPI_INPUT_Z, spi_input_z.value });
...
GX2SetGeometryShader(GX2GeometryShader *shader)
{
   ...
   internal::writePM4(SetContextRegs { latte::Register::SQ_PGM_START_GS, gsl::make_span(shaderRegData) });
   internal::writePM4(SetContextReg { latte::Register::VGT_GS_OUT_PRIM_TYPE, vgt_gs_out_prim_type.value });
   internal::writePM4(SetContextReg { latte::Register::VGT_GS_MODE, vgt_gs_mode.value });
   internal::writePM4(SetContextReg { latte::Register::SQ_GS_VERT_ITEMSIZE, sq_gs_vert_itemsize.value });
   ...
   internal::writePM4(SetContextRegs { latte::Register::SQ_PGM_START_VS, gsl::make_span(vertexShaderRegData) });
   internal::writePM4(SetContextReg { latte::Register::PA_CL_VS_OUT_CNTL, pa_cl_vs_out_cntl.value });
   ...
   internal::writePM4(SetContextReg { latte::Register::SPI_VS_OUT_CONFIG, spi_vs_out_config.value });
   internal::writePM4(SetContextReg { latte::Register::SQ_GSVS_RING_ITEMSIZE, shader->ringItemSize });
                   ...
                   uint32_t numPsGpr, uint32_t numPsStackEntries)
{
   ...
   internal::writePM4(SetConfigRegs { latte::Register::SQ_CONFIG, gsl::make_span(regData) });

   if (mode == GX2ShaderMode::ComputeShader) {
      uint32_t ringBaseData[] = { 0, 0xFFFFFF, 0, 0xFFFFFF };
      internal::writePM4(SetConfigRegs { latte::Register::SQ_ESGS_RING_BASE, gsl::make_span(ringBaseData) });

      uint32_t ringItemSizes[] = { 0, 1 };
      internal::writePM4(SetContextRegs { latte::Register::SQ_ESGS_RING_ITEMSIZE, gsl::make_span(ringItemSizes) });

      internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_EN, 0 });
   }
}
                      ...
                      GX2OutputStream *stream)
{
   ...
   internal::writePM4(SetContextReg { static_cast<latte::Register>(latte::Register::VGT_STRMOUT_BUFFER_SIZE_0 + 16 * index), size >> 2 });
   internal::writePM4(SetContextReg { static_cast<latte::Register>(latte::Register::VGT_STRMOUT_BUFFER_BASE_0 + 16 * index), addr >> 8 });
...
GX2SetStreamOutEnable(BOOL enable)
{
   ...
   internal::writePM4(SetContextReg { latte::Register::VGT_STRMOUT_EN, vgt_strmout_en.value });
}
...
GX2SetGeometryShaderInputRingBuffer(void *buffer,
                                    uint32_t size)
{
   internal::writePM4(SetConfigReg { latte::Register::SQ_ESGS_RING_BASE, mem::untranslate(buffer) >> 8 });
   internal::writePM4(SetConfigReg { latte::Register::SQ_ESGS_RING_SIZE, size >> 8 });
...
GX2SetGeometryShaderOutputRingBuffer(void *buffer,
                                     uint32_t size)
{
   internal::writePM4(SetConfigReg { latte::Register::SQ_GSVS_RING_BASE, mem::untranslate(buffer) >> 8 });
   internal::writePM4(SetConfigReg { latte::Register::SQ_GSVS_RING_SIZE, size >> 8 });
