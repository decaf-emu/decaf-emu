...
GX2_ENUM(GX2AAMode, uint32_t)
   ...
   GX2_ENUM_VALUE(Mode2X, 1)
   GX2_ENUM_VALUE(Mode4X, 2)
   GX2_ENUM_VALUE(Mode8X, 3)
...
GX2_ENUM_WITH_RANGE(GX2InvalidateMode, uint32_t, 1, 0x1ff)
   GX2_ENUM_VALUE(AttributeBuffer,     1 << 0)
   GX2_ENUM_VALUE(Texture,             1 << 1)
   GX2_ENUM_VALUE(UniformBlock,        1 << 2)
   GX2_ENUM_VALUE(Shader,              1 << 3)
   GX2_ENUM_VALUE(ColorBuffer,         1 << 4)
   GX2_ENUM_VALUE(DepthBuffer,         1 << 5)
   GX2_ENUM_VALUE(CPU,                 1 << 6)
   GX2_ENUM_VALUE(StreamOutBuffer,     1 << 7)
   GX2_ENUM_VALUE(ExportBuffer,        1 << 8)
...
GX2_ENUM_WITH_RANGE(GX2TVScanMode, uint32_t, 0, 7)
   GX2_ENUM_VALUE(None, 0)
   GX2_ENUM_VALUE(I480, 1)
   GX2_ENUM_VALUE(P480, 2)
   GX2_ENUM_VALUE(P720, 3)
   GX2_ENUM_VALUE(I1080, 5)
   GX2_ENUM_VALUE(P1080, 6)
