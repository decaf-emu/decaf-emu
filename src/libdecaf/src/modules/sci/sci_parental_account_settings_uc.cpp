                                 ...
                                 uint32_t account)
{
   ...
   UCSysConfig settings[] = {
      { {}, 0x777u, UCDataType::Complex,         UCError::OK, 0u, nullptr },
      { {}, 0x777u, UCDataType::UnsignedShort,   UCError::OK, static_cast<uint32_t>(sizeof(data->version)),                   virt_addrof(data->version) },
      { {}, 0x777u, UCDataType::UnsignedInt,     UCError::OK, static_cast<uint32_t>(sizeof(data->game_rating)),               virt_addrof(data->game_rating) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->eshop_purchase)),            virt_addrof(data->eshop_purchase) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->friend_reg)),                virt_addrof(data->friend_reg) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->acct_modify)),               virt_addrof(data->acct_modify) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->data_manage)),               virt_addrof(data->data_manage) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->int_setting)),               virt_addrof(data->int_setting) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->country_setting)),           virt_addrof(data->country_setting) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->sys_init)),                  virt_addrof(data->sys_init) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->int_browser)),               virt_addrof(data->int_browser) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->int_movie)),                 virt_addrof(data->int_movie) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->net_communication_on_game)), virt_addrof(data->net_communication_on_game) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->network_launcher)),          virt_addrof(data->network_launcher) },
      { {}, 0x777u, UCDataType::UnsignedByte,    UCError::OK, static_cast<uint32_t>(sizeof(data->entertainment_launcher)),    virt_addrof(data->entertainment_launcher) },
   };
