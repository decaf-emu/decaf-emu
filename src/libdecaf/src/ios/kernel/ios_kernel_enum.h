...
ENUM_BEG(OtpFieldIndex, uint32_t)
   ...
   ENUM_VALUE(WiiUStarbuckAncastKey,      0x24)
   ENUM_VALUE(WiiUSeepromKey,             0x28)
   ENUM_VALUE(VwiiCommonKey,              0x34)
   ENUM_VALUE(WiiUCommonKey,              0x38)
   ENUM_VALUE(SslRsaKey,                  0x48)
   ENUM_VALUE(UsbStorageKey,              0x4C)
   ENUM_VALUE(WiiUXorKey,                 0x54)
   ENUM_VALUE(WiiURngKey,                 0x58)
   ENUM_VALUE(WiiUSlcKey,                 0x5C)
   ENUM_VALUE(WiiUMlcKey,                 0x60)
   ENUM_VALUE(ShddKey,                    0x64)
   ENUM_VALUE(DrhWlanKey,                 0x68)
   ENUM_VALUE(WiiUSlcHmac,                0x78)
   ENUM_VALUE(WiiUNgId,                   0x87)
   ENUM_VALUE(WiiUNgPrivateKey,           0x88)
   ENUM_VALUE(WiiUNssPrivateKey,          0x90)
   ENUM_VALUE(WiiUOtpRngSeed,             0x98)
   ENUM_VALUE(WiiURootCertMsId,           0xA0)
   ENUM_VALUE(WiiURootCertCaId,           0xA1)
   ENUM_VALUE(WiiURootCertNgId,           0xC2)
   ENUM_VALUE(WiiURootCertNgSig,          0xC3)
   ENUM_VALUE(WiiKoreanKey,               0xD2)
   ENUM_VALUE(WiiNssPrivateKey,           0xD8)
   ENUM_VALUE(WiiUBoot1Key,               0xE8)
...
ENUM_BEG(OtpFieldSize, uint32_t)
   ...
   ENUM_VALUE(WiiUStarbuckAncastKey,      0x10)
   ENUM_VALUE(WiiUSeepromKey,             0x10)
   ENUM_VALUE(VwiiCommonKey,              0x10)
   ENUM_VALUE(WiiUCommonKey,              0x10)
   ENUM_VALUE(SslRsaKey,                  0x10)
   ENUM_VALUE(UsbStorageKey,              0x10)
   ENUM_VALUE(WiiUXorKey,                 0x10)
   ENUM_VALUE(WiiURngKey,                 0x10)
   ENUM_VALUE(WiiUSlcKey,                 0x10)
   ENUM_VALUE(WiiUMlcKey,                 0x10)
   ENUM_VALUE(ShddKey,                    0x10)
   ENUM_VALUE(DrhWlanKey,                 0x10)
   ENUM_VALUE(WiiUSlcHmac,                0x14)
   ENUM_VALUE(WiiUNgId,                   0x4)
   ENUM_VALUE(WiiUNgPrivateKey,           0x20)
   ENUM_VALUE(WiiUNssPrivateKey,          0x20)
   ENUM_VALUE(WiiUOtpRngSeed,             0x10)
   ENUM_VALUE(WiiURootCertMsId,           0x4)
   ENUM_VALUE(WiiURootCertCaId,           0x4)
   ENUM_VALUE(WiiURootCertNgId,           0x4)
   ENUM_VALUE(WiiURootCertNgSig,          0x3C)
   ENUM_VALUE(WiiKoreanKey,               0x10)
   ENUM_VALUE(WiiNssPrivateKey,           0x20)
   ENUM_VALUE(WiiUBoot1Key,               0x10)
