...
BITFIELD(VGT_DMA_BASE, uint32_t)
...
BITFIELD(VGT_HOS_MAX_TESS_LEVEL, uint32_t)
...
BITFIELD(VGT_HOS_MIN_TESS_LEVEL, uint32_t)
...
BITFIELD(VGT_MULTI_PRIM_IB_RESET_INDX, uint32_t)
   BITFIELD_ENTRY(0, 32, uint32_t, RESET_INDX)
BITFIELD_END

// VGT Number of Indices
BITFIELD(VGT_NUM_INDICES, uint32_t)
   BITFIELD_ENTRY(0, 32, uint32_t, NUM_INDICES)
BITFIELD_END
