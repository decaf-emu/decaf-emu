...
struct CB_BLENDN_CONTROL : public Bitfield<CB_BLENDN_CONTROL, uint32_t>
{
...
struct CB_COLORN_SIZE : public Bitfield<CB_COLORN_SIZE, uint32_t>
{
...
struct CB_COLORN_INFO : public Bitfield<CB_COLORN_INFO, uint32_t>
{
...
struct CB_COLORN_VIEW : public Bitfield<CB_COLORN_VIEW, uint32_t>
{
...
struct CB_COLORN_MASK : public Bitfield<CB_COLORN_MASK, uint32_t>
{
...
struct CB_COLOR_CONTROL : public Bitfield<CB_COLOR_CONTROL, uint32_t>
{
...
struct CB_SHADER_MASK : public Bitfield<CB_SHADER_MASK, uint32_t>
{
...
struct CB_TARGET_MASK : public Bitfield<CB_TARGET_MASK, uint32_t>
{
