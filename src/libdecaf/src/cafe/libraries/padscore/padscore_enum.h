...
ENUM_BEG(KPADReason, int32_t)
   ENUM_VALUE(KPAD_STATE_CTRL_DPD_START,    0)
   ENUM_VALUE(KPAD_STATE_CTRL_DPD_FINISHED, 1)
ENUM_END(KPADReason)

ENUM_BEG(KPADPlayMode, int32_t)
   ENUM_VALUE(KPAD_PLAY_MODE_LOOSE,         0)
   ENUM_VALUE(KPAD_PLAY_MODE_TIGHT,         1)
ENUM_END(KPADPlayMode)

ENUM_BEG(KPADMplsMode, int32_t)
   ENUM_VALUE(WPAD_MPLS_STD,                0)
   ENUM_VALUE(WPAD_MPLS_FS,                 1)
   ENUM_VALUE(WPAD_MPLS_CL,                 2)
ENUM_END(KPADMplsMode)

ENUM_BEG(KPADMplsZeroDriftMode, int32_t)
   ENUM_VALUE(KPAD_MPLS_ZERODRIFT_LOOSE,    0)
   ENUM_VALUE(KPAD_MPLS_ZERODRIFT_STANDARD, 1)
   ENUM_VALUE(KPAD_MPLS_ZERODRIFT_TIGHT,    2)
ENUM_END(KPADMplsZeroDriftMode)
...
ENUM_BEG(WPADProButton, uint32_t)
   ENUM_VALUE(Down,                0x00000001)
   ENUM_VALUE(Up,                  0x00000002)
   ENUM_VALUE(Right,               0x00000004)
   ENUM_VALUE(Left,                0x00000008)
   ENUM_VALUE(A,                   0x00000100)
   ENUM_VALUE(B,                   0x00000200)
   ENUM_VALUE(X,                   0x00000400)
   ENUM_VALUE(Y,                   0x00000800)
   ENUM_VALUE(Plus,                0x00001000)
   ENUM_VALUE(Reserved,            0x00002000)
   ENUM_VALUE(R,                   0x00004000)
   ENUM_VALUE(ZL,                  0x00008000)
   ENUM_VALUE(Home,                0x00000010)
   ENUM_VALUE(Minus,               0x00000020)
   ENUM_VALUE(L,                   0x00000040)
   ENUM_VALUE(ZR,                  0x00000080)
   ENUM_VALUE(StickR,              0x00400000)
   ENUM_VALUE(StickL,              0x00800000)
