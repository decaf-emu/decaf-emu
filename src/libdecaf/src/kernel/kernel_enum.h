...
ENUM_BEG(PhysicalRegion, int32_t)
   ...
   ENUM_VALUE(MEM2,                    6)
   ENUM_VALUE(MEM2IosHeap,             7)
   ENUM_VALUE(MEM2ForegroundBucket,    8)
   ENUM_VALUE(MEM2SharedData,          9)
   ENUM_VALUE(MEM2LoaderHeap,          10)
   ENUM_VALUE(MEM2TilingApertures,     11)
   ENUM_VALUE(MEM2SystemHeap,          12)
   ENUM_VALUE(MEM2OverlayArena,        13)
   ENUM_VALUE(MEM2AppHeap,             14)
   ENUM_VALUE(SRAM1,                   15)
   ENUM_VALUE(SRAM1C2W,                16)
   ENUM_VALUE(SRAM0,                   17)
   ENUM_VALUE(SRAM0IosKernel,          18)
...
ENUM_BEG(VirtualRegion, int32_t)
   ...
   ENUM_VALUE(LoaderHeap,              7)
   ENUM_VALUE(MEM1,                    8)
   ENUM_VALUE(SharedData,              9)
   ENUM_VALUE(LockedCache,             10)
