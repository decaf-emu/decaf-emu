...
{
   pm4::write(pm4::SetContextReg { pm4::Register::PrimitiveRestartIndex, { &index, 1 } });
}
          ...
          uint32_t numInstances)
{
   ...
   pm4::write(pm4::SetConfigReg { pm4::Register::PrimitiveType, { reinterpret_cast<uint32_t*>(&mode), 1 } });
