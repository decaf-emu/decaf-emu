...
getCommandLineParser()
{
   ...
   input_options.add_option("wpad1",
                  description{ "Select the input device for WPAD1." },
                  make_default_value(config::input::wpad[1]));
   input_options.add_option("wpad2",
                  description{ "Select the input device for WPAD2." },
                  make_default_value(config::input::wpad[2]));
