...
void Transpiler::translateAluOp2_CUBE(const ControlFlowInst &cf, const AluInstructionGroup &group, SQ_CHAN unit, const AluInst &inst)
{
   ...
   spv::Id dstX01, dstY01, dstZ01, dstW01;
   {
      ...
      dstX01 = srcY;
      dstY01 = mSpv->createBinOp(spv::OpFMul, mSpv->floatType(), signX, srcZ);
   ...
   spv::Id dstX23, dstY23, dstZ23, dstW23;
   {
      ...
      auto negX = mSpv->createUnaryOp(spv::OpFNegate, mSpv->floatType(), srcX);
      auto negZ = mSpv->createUnaryOp(spv::OpFNegate, mSpv->floatType(), srcZ);

      dstX23 = mSpv->createBinOp(spv::OpFMul, mSpv->floatType(), signY, negX);
      dstY23 = negZ;
   ...
   spv::Id dstX45, dstY45, dstZ45, dstW45;
   {
      ...
      dstX45 = srcY;
      dstY45 = mSpv->createBinOp(spv::OpFMul, mSpv->floatType(), signZ, negX);
   ...
   // the coordinates around differently...
   {
      ...
      dstX = mSpv->createUnaryOp(spv::OpFNegate, mSpv->floatType(), dstX);
      dstY = mSpv->createUnaryOp(spv::OpFNegate, mSpv->floatType(), dstY);
