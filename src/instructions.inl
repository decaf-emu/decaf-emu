...
INS(addme, (rD, XER), (rA), (oe, rc), (opcd == 31, xo2 == 234, !_16_20), "Add to Minus One Extended")
INS(addze, (rD, XER), (rA), (oe, rc), (opcd == 31, xo2 == 202, !_16_20), "Add to Zero Extended")
...
INS(subfme, (rD, XER), (rA), (oe, rc), (opcd == 31, xo2 == 232, !_16_20), "Subtract From Minus One Extended")
INS(subfze, (rD, XER), (rA), (oe, rc), (opcd == 31, xo2 == 200, !_16_20), "Subtract From Zero Extended")

// Integer Compare
INS(cmp, (crfD), (rA, rB), (l), (opcd == 31, xo1 == 0, !_9, !_31), "Compare")
INS(cmpi, (crfD), (rA, simm), (l), (opcd == 11, !_9), "Compare Immediate")
INS(cmpl, (crfD), (rA, rB), (l), (opcd == 31, xo1 == 32, !_9, !_31), "Compare Logical")
INS(cmpli, (crfD), (rA, uimm), (l), (opcd == 10, !_9), "Compare Logical Immediate")
...
INS(fadd, (frD, FPSCR), (frA, frB), (rc), (opcd == 63, xo4 == 21, !_21_25), "Floating Add")
INS(fadds, (frD, FPSCR), (frA, frB), (rc), (opcd == 59, xo4 == 21, !_21_25), "Floating Add Single")
INS(fdiv, (frD, FPSCR), (frA, frB), (rc), (opcd == 63, xo4 == 18, !_21_25), "Floating Divide")
INS(fdivs, (frD, FPSCR), (frA, frB), (rc), (opcd == 59, xo4 == 18, !_21_25), "Floating Divide Single")
INS(fmul, (frD, FPSCR), (frA, frC), (rc), (opcd == 63, xo4 == 25, !_16_20), "Floating Multiply")
INS(fmuls, (frD, FPSCR), (frA, frC), (rc), (opcd == 59, xo4 == 25, !_16_20), "Floating Multiply Single")
INS(fres, (frD, FPSCR), (frB), (rc), (opcd == 59, xo4 == 24, !_11_15, !_21_25), "Floating Reciprocal Estimate Single")
INS(frsqrte, (frD, FPSCR), (frB), (rc), (opcd == 63, xo4 == 26, !_11_15, !_21_25), "Floating Reciprocal Square Root Estimate")
INS(fsub, (frD, FPSCR), (frA, frB), (rc), (opcd == 63, xo4 == 20, !_21_25), "Floating Sub")
INS(fsubs, (frD, FPSCR), (frA, frB), (rc), (opcd == 59, xo4 == 20, !_21_25), "Floating Sub Single")
...
INS(fctiw, (frD, FPSCR), (frB), (rc), (opcd == 63, xo1 == 14, !_11_15), "Floating Convert to Integer Word")
INS(fctiwz, (frD, FPSCR), (frB), (rc), (opcd == 63, xo1 == 15, !_11_15), "Floating Convert to Integer Word with Round toward Zero")
INS(frsp, (frD, FPSCR), (frB), (rc), (opcd == 63, xo1 == 12, !_11_15), "Floating Round to Single")

// Floating-Point Compare
INS(fcmpo, (crfD, FPSCR), (frA, frB), (), (opcd == 63, xo1 == 32, !_9_10, !_31), "Floating Compare Ordered")
INS(fcmpu, (crfD, FPSCR), (frA, frB), (), (opcd == 63, xo1 == 0, !_9_10, !_31), "Floating Compare Unordered")
...
// Processor Control
INS(mcrxr, (crfD), (XER), (), (opcd == 31, xo1 == 512, !_9_10, !_11_15, !_16_20, !_31), "Move to Condition Register from XER")
